    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4><i class="fas fa-plus"></i> Agregar Nueva Función</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('funciones.store') }}" method="POST">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('sala') is-invalid @enderror" 
                                       id="sala" name="sala" value="{{ old('sala') }}" min="1" max="10" required>
                                @error('sala')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('asientos_totales') is-invalid @enderror" 
                                       id="asientos_totales" name="asientos_totales" value="{{ old('asientos_totales', 50) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('asientos_disponibles') is-invalid @enderror" 
                               id="asientos_disponibles" name="asientos_disponibles" value="{{ old('asientos_disponibles', 50) }}" required>
